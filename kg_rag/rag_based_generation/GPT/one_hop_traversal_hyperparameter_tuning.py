...
QUESTION_PATH = "/data/somank/llm_data/analysis/one_hop_graph_traversal_questions_v2.csv"
SAVE_PATH = "/data/somank/llm_data/analysis"
SAVE_NAME = "PubMedBert_node_retrieval_rag_based_one_hop_questions_parameter_tuning_round_{}.csv"
