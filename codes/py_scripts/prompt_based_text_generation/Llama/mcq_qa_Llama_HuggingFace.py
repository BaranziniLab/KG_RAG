...
BRANCH_NAME="main"
QUESTION_PATH="/data1/somank/llm_data/analysis/test_questions_two_hop_mcq_from_disgenet.csv"
...
def main():    
    ...
    SAVE_NAME = "_".join(MODEL_NAME.split("/")[-1].split("-"))+"_prompt_based_two_hop_mcq_from_disgenet_response.csv"
