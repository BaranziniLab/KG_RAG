...
QUESTION_PATH = "../../../../data/benchmark_datasets/test_questions_two_hop_mcq_from_robokop.csv"
SAVE_PATH = "../../../../data/analysis_results"

save_name = "_".join(CHAT_MODEL_ID.split("-"))+"_prompt_based_two_hop_mcq_from_robokop_response.csv"
