...
BRANCH_NAME = "main"
QUESTION_PATH = "/data/somank/llm_data/analysis/test_disease_symptom_questions_two_hop_mcq.csv"
...
def main():    
    ...
    SAVE_NAME = "_".join(MODEL_NAME.split("/")[-1].split("-"))+"_node_retrieval_rag_based_two_hop_mcq_disease_symptom_response.csv"
