...
BRANCH_NAME = "main"
QUESTION_PATH = "/data/somank/llm_data/analysis/test_questions_two_hop.csv"
...
def main():    
    ...
    SAVE_NAME = "_".join(MODEL_NAME.split("/")[-1].split("-"))+"_node_retrieval_rag_based_two_hop_binary_response.csv"
